...
public class GoogleAPI implements API {
    ...
    public GoogleAPI() {
        ...
        rooms[0]=room1;
        Room room2 = new Room(2, 250, 3, new Date(20072016), "Kyivhotel", "Kyiv");
        rooms[01]=room2;
        Room room3 = new Room(3, 200, 6, new Date(20072016), "Kyivhotel", "Kyiv");
        rooms[2]=room3;
        Room room4 = new Room(4, 200, 4, new Date(20072016), "Kyivhotel", "Kyiv");
        rooms[3]=room4;
        Room room5 = new Room(5, 400, 7, new Date(20072016), "Kyivhotel", "Kyiv");
        rooms[4]=room5;
